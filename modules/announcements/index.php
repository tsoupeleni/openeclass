...
curl_setopt($ch,CURLOPT_POSTFIELDS, $fields_string);//ena string pou dimiourgisa parapanw
curl_setopt($ch,CURLOPT_RETURNTRANSFER,1); //vale ta apotelesmata se mia metavliti min ta tipwseis stin othoni
